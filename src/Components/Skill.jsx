  ...
  return (
    <div className="relative w-full overflow-x-auto py-10 font-[sora]">
      <div className="flex items-center justify-start space-x-6 px-4">
        ...
        {/* Skill 1 */}
        <motion.div
          className="relative bg-teal-900  text-center text-xl font-bold text-white p-4 rounded-xl shadow-lg min-w-[200px] z-10"
        ...
        {/* Skill 2 */}
        <motion.div
          className="relative  text-center text-xl font-bold  bg-purple-900 text-white p-4 rounded-xl shadow-lg min-w-[200px] z-10"
          initial={{ opacity: 0, x: -100 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        {/* Skill 3 */}
        <motion.div
          className="relative bg-brown-900 text-center text-xl font-bold text-white bg-yellow-900 p-4 rounded-xl shadow-lg min-w-[200px] z-10"
          initial={{ opacity: 0, x: -100 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        {/* Skill 4 */}
        <motion.div
          className="relative bg-blue-600  text-center text-xl font-bold text-white p-4 rounded-xl shadow-lg min-w-[200px] z-10"
          initial={{ opacity: 0, x: -100 }}
          animate={{ opacity: 1, x: 0 }}
        ...
        >
          <div className="flex flex-col justify-center items-center space-x-2">
            <span className="text-2xl text-red-400 font-bold"><FaReact /></span>
